    ...
    <div id="result" class="module">
        ...
        <div id="result-2">
            ...
            <table>
                ...
                <tr>
                    <?php $opt = "i"; ?>
                    <td><input type="checkbox" name="options[]" value="<?php echo $opt?>" <?php if ($mode_ngrep[$opt][0] == "1") echo "checked" ?> ></td>
                    <td>-<?php echo $opt?></td>
                ...
                <tr>
                    <?php $opt = "M"; ?>
                    <td><input type="checkbox" name="options[]" value="<?php echo $opt?>" <?php if ($mode_ngrep[$opt][0] == "1") echo "checked" ?> ></td>
                    <td style="padding-right:10px">-<?php echo $opt?></td>
        ...
        <div id="result-3" >
            ...
            <input id="inject" name="newdata" type="text" class="module-content" style="font-family: courier; height:20px" value="<?php echo htmlspecialchars($data)?>">
