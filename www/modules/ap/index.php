...
<script src="includes/scripts.js?<?php echo time()?>"></script>
...
<div id="body" style="display:none;">
    ...
    <div id="result" class="module">
        ...
        <div id="tab-dnsmasq">
            ...
            ?>
            <textarea id="output" class="module-content" style="font-family: monospace, courier;"><?php echo htmlspecialchars($data)?></textarea>
        ...
        <div id="tab-ap" class="history">
            ...
            <h4>
                <input id="mod_nethunter" type="checkbox" name="my-checkbox" <?php if ($mod_nethunter == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_nethunter')" >
                NetHunter
            </h4> 
            ...
            <h5>
                ...
                <select class="btn btn-default btn-sm" id="ap_hw_mode" onchange="setOptionSelect(this, 'mod_ap_hw_mode')" style="width: 70px">
                    <option <?php if ($mod_ap_hw_mode == "a") echo "selected"?> >a</option>
                    <option <?php if ($mod_ap_hw_mode == "b") echo "selected"?> >b</option>
                    <option <?php if ($mod_ap_hw_mode == "g") echo "selected"?> >g</option>
                </select>
                ...
                <input id="ap_ht_capab_enabled" type="checkbox" name="my-checkbox" <?php if ($mod_ap_ht_capab_enabled == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_ap_ht_capab_enabled')" >
                ht_capab
                <br>
                <input id="ap_ht_capab" class="form-control input-sm" placeholder="ht_capab" value="<?php echo $mod_ap_ht_capab;?>" style="width: 145px; display: inline-block; " type="text" />
                ...
                <form action="includes/save.php" method="POST">
                    <input id="ap_ht_capab" name="ap_ht_capab" class="form-control input-sm" placeholder="ht_capab" value="<?php echo $mod_ap_ht_capab;?>" style="width: 145px; display: inline-block; " type="text" />
                    <input class="btn btn-default btn-sm" type="submit" value="save">
                </form>
                
                <br>
                
                <input id="mod_ap_wme_enabled" type="checkbox" name="my-checkbox" <?php if ($mod_ap_wme_enabled == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_ap_wme_enabled')" >
                wme_enabled
                <br>
                <input id="mod_ap_wmm_enabled" type="checkbox" name="my-checkbox" <?php if ($mod_ap_wmm_enabled == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_ap_wmm_enabled')" >
                wmm_enabled
                <br>
                <input id="mod_ap_ieee80211n" type="checkbox" name="my-checkbox" <?php if ($mod_ap_ieee80211n == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_ap_ieee80211n')" >
                ieee80211n
                
            </h5>
            
            <h5>
                <input id="mod_ap_mana_loud" type="checkbox" name="my-checkbox" <?php if ($mod_ap_mana_loud == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_ap_mana_loud')" >
                mana_loud (Mana only)
            </h5>
            ...
            <div class="btn-group btn-group-sm" data-toggle="buttons">
                <label class="btn btn-default <?php if ($mod_filter_karma_station == "none") echo "active" ?>">
                  <input type="radio" name="mod_filter_karma_station" id="none" autocomplete="off" checked> None
                </label>
                <label class="btn btn-default <?php if ($mod_filter_karma_station == "whitelist") echo "active" ?>">
                  <input type="radio" name="mod_filter_karma_station" id="whitelist" autocomplete="off"> Whitelist
                </label>
                <label class="btn btn-default <?php if ($mod_filter_karma_station == "blacklist") echo "active" ?>">
            ...
            <br>
            <div class="btn-group btn-group-sm" data-toggle="buttons">
                <label class="btn btn-default <?php if ($mod_filter_karma_ssid == "none") echo "active" ?>">
                  <input type="radio" name="mod_filter_karma_ssid" id="none" autocomplete="off" <?php if ($mod_filter_karma_ssid == "none") echo "checked" ?> > None
                </label>
                <label class="btn btn-default <?php if ($mod_filter_karma_ssid == "whitelist") echo "active" ?>">
                  <input type="radio" name="mod_filter_karma_ssid" id="whitelist" autocomplete="off" <?php if ($mod_filter_karma_ssid == "whitelist") echo "checked" ?> > Whitelist
                </label>
                <label class="btn btn-default <?php if ($mod_filter_karma_ssid == "blacklist") echo "active" ?>">
                  <input type="radio" name="mod_filter_karma_ssid" id="blacklist" autocomplete="off" <?php if ($mod_filter_karma_ssid == "blacklist") echo "checked" ?> > Blacklist
                </label>
            </div>
            ...
            <script>
                ...
                for(var i in country_code) {
                    if (country_code[i] == "<?php echo $mod_ap_country_code?>") {
                ...
                var stored_hw_mode = "<?php echo $mod_ap_hw_mode?>";
                var stored_channel = "<?php echo $mod_ap_channel?>";
        ...
        <div id="tab-worker" class="history">
            ...
            <div class="btn-group btn-group-sm" data-toggle="buttons">
                <label class="btn btn-default <?php if ($mod_filter_scatter_ssid == "none") echo "active" ?>">
                  <input type="radio" name="mod_filter_scatter_ssid" id="none" autocomplete="off" checked> None
                </label>
                <label class="btn btn-default <?php if ($mod_filter_scatter_ssid == "whitelist") echo "active" ?>">
                  <input type="radio" name="mod_filter_scatter_ssid" id="whitelist" autocomplete="off"> Whitelist
                </label>
                <label class="btn btn-default <?php if ($mod_filter_scatter_ssid == "blacklist") echo "active" ?>">
            ...
            <input id="filter_scatter_bssid" type="checkbox" name="my-checkbox" <?php if ($mod_filter_scatter_bssid == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_filter_scatter_bssid')" >
            Rogue BSSID
            <br>
            <input id="scatter_bssid" class="form-control input-sm" placeholder="BSSID" value="<?php echo $mod_scatter_bssid;?>" style="width: 120px; display: inline-block; " type="text" />
            <input class="btn btn-default btn-sm" type="submit" value="save" onclick="setOption('scatter_bssid', 'mod_scatter_bssid')">

            <br><br>
            
            <input id="filter_scatter_station" type="checkbox" name="my-checkbox" <?php if ($mod_filter_scatter_station == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_filter_scatter_station')" >
            Target
            <br>
            <input id="scatter_station" class="form-control input-sm" placeholder="Station" value="<?php echo $mod_scatter_station?>" style="width: 120px; display: inline-block; " type="text" />
            ...
            <br>
            <div class="btn-group btn-group-sm" data-toggle="buttons">
                <label class="btn btn-default <?php if ($mod_filter_polite_station == "none") echo "active" ?>">
                  <input type="radio" name="mod_filter_polite_station" id="none" autocomplete="off" checked> None
                </label>
                <label class="btn btn-default <?php if ($mod_filter_polite_station == "whitelist") echo "active" ?>">
                  <input type="radio" name="mod_filter_polite_station" id="whitelist" autocomplete="off"> Whitelist
                </label>
                <label class="btn btn-default <?php if ($mod_filter_polite_station == "blacklist") echo "active" ?>">
            ...
            <br>
            <div class="btn-group btn-group-sm" data-toggle="buttons">
                <label class="btn btn-default <?php if ($mod_filter_polite_ssid == "none") echo "active" ?>">
                  <input type="radio" name="mod_filter_polite_ssid" id="none" autocomplete="off" checked> None
                </label>
                <label class="btn btn-default <?php if ($mod_filter_polite_ssid == "whitelist") echo "active" ?>">
                  <input type="radio" name="mod_filter_polite_ssid" id="whitelist" autocomplete="off"> Whitelist
                </label>
                <label class="btn btn-default <?php if ($mod_filter_polite_ssid == "blacklist") echo "active" ?>">
        ...
        <div id="tab-dns-config" class="history">
            <h4>
                <!-- <input id="mod_dhcp" type="checkbox" name="my-checkbox" <?php if ($mod_dhcp == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_dhcp')" > -->
                DHCP
            </h4>
            ...
            ?>
            LEASE IP (<?php echo $range?>.xx - <?php echo $range?>.yy)
            <br>
            <input id="dhcp_lease_start" class="form-control input-sm" placeholder="START" value="<?php echo $mod_dhcp_lease_start;?>" style="width: 50px; display: inline-block; font-family: monospace; " type="text" />
            -
            <input id="dhcp_lease_end" class="form-control input-sm" placeholder="END" value="<?php echo $mod_dhcp_lease_end;?>" style="width: 50px; display: inline-block; font-family: monospace; " type="text" />
            ...
            <h4>
                <!-- <input id="mod_dns" type="checkbox" name="my-checkbox" <?php if ($mod_dns == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_dns')" > -->
                DNS
            </h4>
            
            <div class="btn-group btn-group-sm" data-toggle="buttons">
                <label class="btn btn-default <?php if ($mod_dns_type == "dnsmasq") echo "active" ?>">
                  <input type="radio" name="mod_dns_type" id="dnsmasq" autocomplete="off" checked> DNSmasq
                </label>
                <label class="btn btn-default <?php if ($mod_dns_type == "fruitydns") echo "active" ?>">
            ...
            <input id="mod_dns_server" type="checkbox" name="my-checkbox" <?php if ($mod_dns_server == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_dns_server')" >
            SET DNS SERVER
            <br>
            <input id="dns_server_ip" class="form-control input-sm" placeholder="DNS-SERVERs" value="<?php echo $mod_dns_server_ip;?>" style="width: 120px; display: inline-block; font-family: monospace " type="text" />
            <input class="btn btn-default btn-sm" type="submit" value="save" onclick="setOption('dns_server_ip', 'mod_dns_server_ip')">
            -->
            <br><br>
            
            <input id="mod_dns_spoof_all" type="checkbox" name="my-checkbox" <?php if ($mod_dns_spoof_all == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_dns_spoof_all')" >
            SPOOF ALL (option dnsmasq)
            
            <hr>
            <!--
            <input id="mod_dnsmasq_dhcp_script" type="checkbox" name="my-checkbox" <?php if ($mod_dnsmasq_dhcp_script == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_dnsmasq_dhcp_script')" >
            DNSMASQ SCRIPT
            
            <br>
            -->
            
            <input id="mod_network_manager_stop" type="checkbox" name="my-checkbox" <?php if ($mod_network_manager_stop == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_network_manager_stop')" >
            NETWORK-MANAGER (stop)
            
            <!--
            <br>
            <input id="dns_spoof_all_ip" class="form-control input-sm" placeholder="BSSID" value="<?php echo $mod_dns_spoof_all_ip;?>" style="width: 120px; display: inline-block; font-family: monospace " type="text" />
            <input class="btn btn-default btn-sm" type="submit" value="save" onclick="setOption('dns_spoof_all_ip', 'mod_dns_spoof_all_ip')">
            
            <br><br>
            
            <input id="dns_server_option" type="checkbox" name="my-checkbox" <?php if ($mod_dns_server_option == "1") echo "checked"; ?> onclick="setCheckbox(this, 'dns_server_option')" >
