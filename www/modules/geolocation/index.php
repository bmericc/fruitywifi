    ...
    <div id="result" class="module">
        ...
        <div id="tab-options" class="history">
            ...
            <h5>
                ...
                Wait (seconds)
                <br>
                <input id="geolocation_wait" class="form-control input-sm" placeholder="Wait" value="<?php echo $mod_geolocation_wait?>" style="width: 180px; display: inline-block; " type="text" />
                ...
                Threads (default 5)
                <br>
                <input id="geolocation_threads" class="form-control input-sm" placeholder="Wait" value="<?php echo $mod_geolocation_threads?>" style="width: 180px; display: inline-block; " type="text" />
        ...
        <div id="tab-templates" class="history">
            <form id="formTemplates" name="formTemplates" method="POST" autocomplete="off" action="includes/save.php">
                ...
                ?>
                <textarea id="inject" name="newdata" class="btn btn-default btn-sm" c-lass="module-content" style="width: 100%; height: 160px; text-align: left; font-family: courier;"><?php echo htmlspecialchars($data)?></textarea>
