...
setRedirect();
?>
<?php print_header($portal_name); ?>

<link rel="stylesheet" href="style.css" />
<h1>Welcome to <?php echo $mod_captive_portal_name;?></h1>

To access you must first enter your details:<br><br>
<form name="access" action="<?php echo $next_page?>?r_url=<?php echo $r_url?>" method='POST' autocomplete="off">
...
<?php if ($_GET["msg"] == "1") echo "<font color='red'>The login details you entered is incorrect.</font><br>"; ?>
