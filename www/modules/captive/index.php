...
<div id="body" style="display:none;">
    ...
    <div id="result" class="module">
        ...
        <div id="tab-options" class="history">
            ...
            <h5>
                ...
                <div class="btn-group btn-group-sm" data-toggle="buttons">
                    <label class="btn btn-default <?php if ($mod_captive_block == "open") echo "active" ?>">
                      <input type="radio" name="mod_captive_block" id="open" autocomplete="off" checked> Open
                    </label>
                    <label class="btn btn-default <?php if ($mod_captive_block == "close") echo "active" ?>">
                ...
                <input id="captive_site" type="checkbox" name="my-checkbox" <?php if ($mod_captive_site == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_captive_site')" > Portal URL
                <br>
                <input id="captive_site_value" class="form-control input-sm" placeholder="URL" value="<?php echo $mod_captive_site_value?>" style="width: 200px; display: inline-block; " type="text" />
                ...
                Portal Name
                <br>
                <input id="captive_portal_name" class="form-control input-sm" placeholder="Portal Name" value="<?php echo $mod_captive_portal_name?>" style="width: 200px; display: inline-block; " type="text" />
                <input class="btn btn-default btn-sm" type="submit" value="save" onclick="setOption('captive_portal_name', 'mod_captive_portal_name')">
                
                <br><br>
                <input id="captive_policy" type="checkbox" name="my-checkbox" <?php if ($mod_captive_policy == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_captive_policy')" > Show Policy Page
                <br>
                <input id="captive_welcome" type="checkbox" name="my-checkbox" <?php if ($mod_captive_welcome == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_captive_welcome')" > Show Welcome Page
                                
                <br><br>
                <input id="captive_recon" type="checkbox" name="my-checkbox" <?php if ($mod_captive_recon == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_captive_recon')" > Recon (inject recon)
                <br>
                <input id="captive_inject" type="checkbox" name="my-checkbox" <?php if ($mod_captive_inject == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_captive_inject')" > Inject (inject code)
                
                <br><br>
                <input id="captive_validate_user" type="checkbox" name="my-checkbox" <?php if ($mod_captive_validate_user == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_captive_validate_user')" > Validate User/Email
                <br>
                <input id="captive_validate_pass" type="checkbox" name="my-checkbox" <?php if ($mod_captive_validate_pass == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_captive_validate_pass')" > Validate Pass

                <br><br>
                <div style="width: 30px; display: inline-block">User</div> <input id="captive_portal_user" class="form-control input-sm" placeholder="User/Email" value="<?php echo $mod_captive_portal_user?>" style="width: 120px; display: inline-block; " type="text" />
                <br>
                <div style="width: 30px; display: inline-block">Pass</div> <input id="captive_portal_pass" class="form-control input-sm" placeholder="Password" value="<?php echo $mod_captive_portal_pass?>" style="width: 120px; display: inline-block; " type="text" />
            ...
            <h5>
                ...
                ?>
                    <input id="captive_template_<?php echo $value?>" value="<?php echo $value?>" type="radio" name="my-radio" <?php if ($mod_captive_template == $value) echo "checked"; ?> onclick="setRadio(this, 'mod_captive_template')" > <?php echo $value?>
                    <br>
                <?php } ?>
            </h5>
            ...
            <h4>Redirect</h4>
            <h5>
                <input id="captive_redirect_change_http" type="checkbox" name="my-checkbox" <?php if ($mod_captive_redirect_change_http == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_captive_redirect_change_http')" > http2https
                <br>
                <input id="captive_redirect_change_www" type="checkbox" name="my-checkbox" <?php if ($mod_captive_redirect_change_www == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_captive_redirect_change_www')" > Add | Remove www (oposite)
                <br>
                <input id="captive_redirect_timestamp" type="checkbox" name="my-checkbox" <?php if ($mod_captive_redirect_timestamp == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_captive_redirect_timestamp')" > Timestamp (add)
                
                <br><br>
                
                <input id="captive_redirect" type="checkbox" name="my-checkbox" <?php if ($mod_captive_redirect == "1") echo "checked"; ?> onclick="setCheckbox(this, 'mod_captive_redirect')" > Force Redirect
                <br>
                <input id="captive_redirect_value" class="form-control input-sm" placeholder="Redirect" value="<?php echo $mod_captive_redirect_value?>" style="width: 200px; display: inline-block; " type="text" />
        ...
        <div id="tab-inject" >
            ...
            ?>
            <textarea id="inject" name="newdata" class="module-content" style="font-family: monospace, courier;"><?php echo htmlspecialchars($data)?></textarea>
