...
if($service == "captive") {
    ...
    if ($action == "start") {
        ...
        if ($isphishingup  != "") {
            ...
            $exec = "sed -i 1i'<?php include \\\"site\/index.php\\\"; \/\* FruityWifi-Phishing \*\/ ?>' /var/www/index.php";
			exec_fruitywifi($exec);
            
            $exec = "sed -i 1i'<?php header(\\\"Location: captive\/index.php\\\"); exit; \/\* FruityWifi-Captive \*\/ ?>' /var/www/index.php";
			exec_fruitywifi($exec);
