...
<div id="body" style="display:none;">
    ...
    <div id="result" class="module">
        ...
        <div id="result-2" class="module-options">
            ...
            ?>
                <tr>
                    <td style="padding-right:5px"><a href="includes/module_action.php?service=users&action=delete&id_data=<?php echo $row[0]?>" style="color:#000">Delete</a></td>
                    <td style="background-color:#DDD; padding-right:10px"><?php echo $row[0];?></td>
                    <td style="background-color:#DDD; padding-right:10px"><?php echo $row[1];?></td>
                    <td style="background-color:#DDD; padding-right:10px"><?php echo $row[2];?></td>
                    <td style="background-color:#DDD; padding-right:10px"><?php echo $row[3];?></td>
                </tr>
            <?php  } 
            } 
            ?>
