...
<div id="body" style="display:none;">
    ...
    <div id="result" class="module">
            ...
            <form method="POST" autocomplete="off" action="includes/save.php">
                <div class="module-options">
                    <table>
                        <tr>
                            <td>User: </td>
                            <td><input name="autossh_user" value="<?php echo $autossh_user?>"></td>
                        </tr>
                        <tr>
                            <td>Host: </td>
                            <td><input name="autossh_host" value="<?php echo $autossh_host?>"></td>
                        </tr>
                        <tr>
                            <td>LPort: </td>
                            <td><input name="autossh_port" value="<?php echo $autossh_port?>"></td>
                        </tr>
                        <tr>
                            <td>Listen: </td>
                            <td><input name="autossh_listen" value="<?php echo $autossh_listen?>"></td>
                        </tr>
                        <tr>
                            <td>RPort: </td>
                            <td><input name="autossh_rport" value="<?php echo $autossh_rport?>"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
		...
		$filename = "./includes/id_rsa.pub";
            ...
            ?>
            <textarea id="output" class="module-content" style="font-family: courier; height: 100px"><?php echo htmlspecialchars($data)?></textarea>
