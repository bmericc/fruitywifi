...
<div class="rounded-bottom">
  <form name="ss_mode" style="margin=0px" action="includes/module_action.php" method="GET">
    ...
    <select name="action" class="module" onchange='this.form.submit()' <?php if ($ismoduleup != "") echo "disabled"?>>
        <?php
...
<div id="body" style="display:none;">
    ...
    <div id="result" class="module">
        ...
        <div id="result-2" >
            ...
            <textarea id="inject" name="newdata" type="text" class="module-content" style="font-family: courier;"><?php echo htmlspecialchars($data)?></textarea>
